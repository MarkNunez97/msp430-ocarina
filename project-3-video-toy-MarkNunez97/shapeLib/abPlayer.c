 ...
 */
int 
abPlayerCheck(const AbRArrow *player, const Vec2 *centerPos, const Vec2 *pixel)
{
  Vec2 relPos;
 ...
 */
void 
abPlayerGetBounds(const AbRArrow *player, const Vec2 *centerPos, Region *bounds)
{
  int size = player->size, halfSize = size / 2;
